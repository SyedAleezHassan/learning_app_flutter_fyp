        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text(
                "We use the information we collect or receive for the following purposes.. To facilitate account creation and login processes..To facilitate account creation and login processes",
                style: Theme.of(context).textTheme.bodyText1!.copyWith(
                      fontSize: 16,
                      color: Theme.of(context).textTheme.bodyText1!.color!,
                      //     .withOpacity(0.7)
